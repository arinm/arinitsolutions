          ...
          {phases.map((phase, i) => (
            ...
            >
              {compact ? (
                ...
                <div className="bg-neutral-900 border border-neutral-700 rounded-xl p-6 h-full">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="text-lg font-medium text-neutral-50">{phase.label}</h3>
                  </div>
                  <p className="text-sm text-neutral-300 leading-relaxed">{phase.description}</p>
                </div>
              ) : (
                /* Expanded / vertical mode with connecting line */
                <>
                  {/* Connecting line */}
                  {i < phases.length - 1 && (
                    <div className="absolute left-[18px] md:left-[26px] top-10 bottom-0 w-px bg-neutral-700" aria-hidden="true" />
                  )}
                  {/* Node */}
                  ...
                  <div className="pb-8">
                    ...
                    <p className="text-neutral-300 leading-relaxed mb-3">{phase.description}</p>
                    {phase.deliverables && (
