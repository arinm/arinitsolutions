  ...
  return (
    <section className="py-16 md:py-24">
      <Container className="max-w-[720px]">
        <h1 className="text-3xl font-bold text-neutral-50 tracking-tight mb-2">Privacy Policy</h1>
        ...
        <div className="space-y-8 [&>h2]:text-xl [&>h2]:font-semibold [&>h2]:text-neutral-50 [&>h2]:mt-10 [&>h2]:mb-3 [&>p]:text-neutral-300 [&>p]:leading-relaxed [&>ul]:space-y-2 [&>ul>li]:text-neutral-300 [&>ul>li]:pl-4 [&>ul>li]:relative [&>ul>li]:before:content-['•'] [&>ul>li]:before:absolute [&>ul>li]:before:left-0 [&>ul>li]:before:text-accent-400">
          ...
          <h2>Your rights</h2>
          <p>Under GDPR, you have the right to access, rectify, delete, port, and object to processing of your personal data. Contact us at hello@arinitsolutions.com to exercise these rights.</p>

          <h2>Contact</h2>
          <p>For privacy-related questions, contact us at hello@arinitsolutions.com.</p>
