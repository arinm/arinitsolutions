  ...
  return (
    <>
      ...
      <section className="py-16 md:py-20 border-t border-neutral-700/50">
        <Container>
          <h2 className="text-2xl sm:text-3xl font-bold text-neutral-50 tracking-tight text-center mb-10">What we believe</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {principles.map((p) => (
              <Card key={p.title} variant="default">
                <p.icon className="h-5 w-5 text-accent-400 mb-3" />
                <h3 className="text-lg font-medium text-neutral-50 mb-1">{p.title}</h3>
      ...
      <section className="py-16 md:py-20 border-t border-neutral-700/50">
        <Container>
          <h2 className="text-2xl sm:text-3xl font-bold text-neutral-50 tracking-tight text-center mb-4">Nothing ships without passing</h2>
          <p className="text-neutral-300 text-center mb-10 max-w-md mx-auto">Our quality gates ensure every release meets the bar.</p>
