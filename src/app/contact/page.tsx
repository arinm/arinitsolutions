...
const serviceOptions = [
  ...
  { value: "ai", label: "AI & LLM Solutions" },
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
            ...
            <Card variant="elevated" className="flex flex-col items-center justify-center min-h-[400px]">
              <div className="text-center">
                ...
                <h2 className="text-xl font-bold text-neutral-50 mb-2">Book a Call</h2>
            ...
            <Card variant="elevated">
              {submitted ? (
                <div className="flex flex-col items-center justify-center min-h-[400px] text-center">
                  ...
                  <h2 className="text-xl font-bold text-neutral-50 mb-2">Brief received</h2>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                  <h2 className="text-xl font-bold text-neutral-50 mb-4">Send a Brief</h2>
          ...
          <div className="mt-16 flex flex-col sm:flex-row items-center justify-center gap-8 text-sm text-neutral-500">
            <div className="flex items-center gap-2">
              ...
              <a href="mailto:arin@arinitsolutions.com" className="hover:text-neutral-300 transition-colors">
                arin@arinitsolutions.com
              </a>
            </div>
            <div className="flex items-center gap-2">
