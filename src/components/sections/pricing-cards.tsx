        ...
        <motion.div key={plan.name} variants={reduced ? undefined : staggerItem} className="relative">
          ...
          >
            ...
            <div className="mt-6 mb-6">
              ...
              <div className="text-4xl font-bold text-neutral-50 tracking-tight mt-1">{plan.price}</div>
            </div>
            ...
            <Link
              href="/contact"
              className={cn(
                "mt-8 flex items-center justify-center h-14 rounded-full font-medium transition-all",
                plan.highlighted
                  ? "bg-accent-500 text-white hover:bg-accent-600 hover:shadow-[0_0_30px_rgba(139,92,246,0.35)]"
                  : "border border-neutral-700 text-neutral-200 hover:bg-neutral-800/60 hover:border-neutral-600"
              )}
