...
const footerColumns = [
  {
    ...
    links: [
      ...
      { label: "AI & LLM Solutions", href: "/services/ai" },
    ],
  },
  {
    title: "Company",
...
export function Footer() {
  return (
    <footer className="border-t border-neutral-700/30 bg-neutral-950" role="contentinfo">
      <Container className="py-20">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-4">
          {/* Brand column */}
          <div>
            <Link href="/" className="text-xl font-bold tracking-tight text-neutral-50">
              Arinit
            </Link>
          ...
          {footerColumns.map((col) => (
            <div key={col.title}>
              <h3 className="text-xs uppercase tracking-widest text-neutral-400 mb-5">{col.title}</h3>
        ...
        {/* Bottom bar */}
        <div className="mt-16 pt-8 border-t border-neutral-700/30 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
